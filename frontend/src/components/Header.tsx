...
import { Search, Filter, LayoutGrid, LayoutDashboard, History, TrendingUp, TrendingDown } from 'lucide-react';
import { FilterStatus } from '../types';
import MarketMatrixLogo from './MarketMatrixLogo';
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                  <div className="p-2 rounded-lg shadow-lg shadow-emerald-500/20">
                      <MarketMatrixLogo size={32} />
                  </div>
                  <div>
                      <h1 className="text-2xl font-serif font-semibold bg-gradient-to-r from-white to-slate-400 bg-clip-text text-transparent">
                          Market Matrix
                      </h1>
                      <p className="text-caption-sm text-slate-400 mt-0.5 font-medium">Algorithmic Trend Intelligence</p>
                  </div>
                  {isTimeTraveling && (
                      <div className="hidden sm:flex px-3 py-1 bg-amber-500/20 border border-amber-500/50 rounded-full items-center gap-2 animate-pulse ml-4">
                          ...
                          <span className="text-caption-sm font-bold text-amber-500 uppercase">Viewing Past Data</span>
                      </div>
                  )}
              </div>
              ...
              <div className="relative group">
                  ...
                  className="bg-slate-800 text-charcoal pl-10 pr-4 py-2 rounded-lg border border-slate-700 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 w-full sm:w-48 transition-all font-medium"
                  />
              </div>
              ...
              <div className="relative">
                  ...
                  className="appearance-none bg-slate-800 text-charcoal pl-4 pr-10 py-2 rounded-lg border border-slate-700 focus:outline-none focus:border-emerald-500 w-full sm:w-40 cursor-pointer font-medium"
                  >
              ...
              <div className="flex bg-slate-800 p-1 rounded-lg border border-slate-700">
                  ...
                  <button
                      ...
                      className={`px-3 py-1.5 rounded-md text-caption-sm font-bold transition-all ${
                      statusFilter === status
          ...
          {!loading && (
              <div className="w-full bg-slate-800/50 rounded-lg p-3 flex flex-col sm:flex-row items-center gap-3 sm:gap-4 border border-slate-800 transition-all duration-500">
                  <div className="text-caption-sm font-bold text-slate-300 whitespace-nowrap flex items-center gap-2 w-full sm:w-auto justify-between sm:justify-start">
                  ...
                  <div className="flex gap-4 text-caption-sm font-mono text-slate-400 w-full sm:w-auto justify-end">
